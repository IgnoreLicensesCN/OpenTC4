...
public class TileEldritchTrap extends TileEntity {
   ...
   public void updateEntity() {
      ...
      if (!this.worldObj.isRemote && this.count-- <= 0) {
         ...
         EntityPlayer p = this.worldObj.getClosestPlayer((double)this.xCoord + (double)0.5F, (double)this.yCoord + (double)0.5F, (double)this.zCoord + (double)0.5F, (double)3.0F);
         if (p != null) {
