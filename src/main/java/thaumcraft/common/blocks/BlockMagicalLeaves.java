         ...
         if ((metadata & 8) != 0 && (metadata & 4) == 0) {
            ...
            if (par1World.checkChunksExist(x - var8, y - var8, z - var8, x + var8, y + var8, z + var8)) {
               ...
               for(int var17 = 1; var17 <= 4; ++var17) {
                  for(int var13 = -var7; var13 <= var7; ++var13) {
                     for(int var14 = -var7; var14 <= var7; ++var14) {
                        for(int var21 = -var7; var21 <= var7; ++var21) {
                           if (this.adjacentTreeBlocks[(var13 + var11) * var10 + (var14 + var11) * var9 + var21 + var11] == var17 - 1) {
                              if (this.adjacentTreeBlocks[(var13 + var11 - 1) * var10 + (var14 + var11) * var9 + var21 + var11] == -2) {
                                 this.adjacentTreeBlocks[(var13 + var11 - 1) * var10 + (var14 + var11) * var9 + var21 + var11] = var17;
                              }
                              ...
                              if (this.adjacentTreeBlocks[(var13 + var11) * var10 + (var14 + var11 - 1) * var9 + var21 + var11] == -2) {
                                 this.adjacentTreeBlocks[(var13 + var11) * var10 + (var14 + var11 - 1) * var9 + var21 + var11] = var17;
                              }
                              ...
                              if (this.adjacentTreeBlocks[(var13 + var11) * var10 + (var14 + var11) * var9 + (var21 + var11 - 1)] == -2) {
                                 this.adjacentTreeBlocks[(var13 + var11) * var10 + (var14 + var11) * var9 + (var21 + var11 - 1)] = var17;
                              }
