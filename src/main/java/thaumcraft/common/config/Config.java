...
public class Config {
   ...
   public static ArrayList aspectOrder = new ArrayList<>();
   ...
   public static void initialize(File file) {
      ...
      config.load();
      syncConfigurable();
      Property btcp = config.get("Biomes", "taint_biome_weight", 2);
      ...
      Property biomeTaintProp = config.get("Biomes", "biome_taint", biomeTaintID);
      ...
      Property mfcp = config.get("Biomes", "magical_forest_biome_weight", 5);
      ...
      int encIdx = 150;
      Property enchHas = config.get("Enchantments", "ench_haste", encIdx++);
      ...
      Property enchRep = config.get("Enchantments", "ench_repair", encIdx++);
   ...
   public static void syncConfigurable() {
      ...
      genInfusedStone = config.get("World_Generation", "generate_infused_stone", true).getBoolean(true);
      genTrees = config.get("World_Generation", "generate_trees", true).getBoolean(true);
      Property gt = config.get("World_Generation", "generate_taint", genTaint);
      ...
      regenInfusedStone = config.get("World_Regeneration", "infused_stone", false).getBoolean(false);
      regenTrees = config.get("World_Regeneration", "trees", false).getBoolean(false);
      regenTaint = config.get("World_Regeneration", "taint", false).getBoolean(false);
      ...
      Property aspTotCap = config.get("Research", "aspect_total_cap", 100);
      ...
      spawnTaintSpore = config.get("Monster_Spawning", "spawn_taint_spores", true).getBoolean(true);
      ...
      Property rss = config.get("Runic_Shielding", "runic_recharge_speed", shieldRecharge);
      ...
      Property rsd = config.get("Runic_Shielding", "runic_recharge_delay", shieldWait);
      ...
      Property rsc = config.get("Runic_Shielding", "runic_cost", shieldCost);
   ...
   public static void initModCompatibility() {
      ...
      for(String ore : ores) {
         if (ore != null) {
            if (ore.equals("oreCopper") && OreDictionary.getOres(ore).size() > 0) {
               foundCopperOre = true;
            ...
            if (ore.equals("oreTin") && OreDictionary.getOres(ore).size() > 0) {
               foundTinOre = true;
            ...
            if (ore.equals("oreSilver") && OreDictionary.getOres(ore).size() > 0) {
               foundSilverOre = true;
            ...
            if (ore.equals("oreLead") && OreDictionary.getOres(ore).size() > 0) {
               foundLeadOre = true;
