...
public class EntityItemGrate extends EntityItem {
   ...
   protected boolean func_145771_j(double x, double y, double z) {
      ...
      return this.worldObj.getBlock(i, j, k) != ConfigBlocks.blockMetalDevice || this.worldObj.getBlockMetadata(i, j, k) != 5 && this.worldObj.getBlockMetadata(i, j, k) != 6 ? super.func_145771_j(x, y, z) : true;
   }
}
