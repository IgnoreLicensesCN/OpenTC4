...
public class TileEtherealBloomRenderer extends TileEntitySpecialRenderer {
   ...
   public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float par8) {
      ...
      UtilsFX.renderFacingStrip((double)tile.xCoord + (double)0.5F, (double)((float)tile.yCoord + scale1), (double)tile.zCoord + (double)0.5F, 0.0F, scale1, 1.0F, 32, 6, i, par8, 11197951);
      GL11.glEnable(2884);
      ...
      for(int a = 0; a < 4; ++a) {
         GL11.glPushMatrix();
         GL11.glTranslated((double)0.0F, (double)((1.0F - scale1) / 2.0F), (double)0.0F);
