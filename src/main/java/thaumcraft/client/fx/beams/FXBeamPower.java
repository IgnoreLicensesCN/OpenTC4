...
public class FXBeamPower extends EntityFX {
   ...
   public FXBeamPower(World par1World, double px, double py, double pz, double tx, double ty, double tz, float red, float green, float blue, int age) {
      super(par1World, px, py, pz, (double)0.0F, (double)0.0F, (double)0.0F);
   ...
   public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      for(int t = 0; t < 2; ++t) {
         ...
         tessellator.addVertexWithUV(var44, var29, (double)0.0F, var33, var37);
         ...
         tessellator.addVertexWithUV(var17, var29, (double)0.0F, var31, var37);
         tessellator.draw();
      }
